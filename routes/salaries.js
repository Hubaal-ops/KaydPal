...
router.get('/export/excel', verifyToken, salaryController.exportSalaries);

// Download salary import template
router.get('/template/download', verifyToken, salaryController.downloadTemplate);
...
router.post(
  ...
  upload.single('file'),
  handleUploadError,
  salaryController.importSalaries
);
