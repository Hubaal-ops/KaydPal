...
router.get('/export/excel', verifyToken, paymentOutController.exportPaymentsOut);

// Download payment out import template
router.get('/template/download', verifyToken, paymentOutController.downloadTemplate);
...
router.post(
  ...
  upload.single('file'),
  handleUploadError,
  paymentOutController.importPaymentsOut
);
