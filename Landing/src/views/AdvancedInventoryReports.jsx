...
const AdvancedInventoryReports = () => {
  ...
  // State for stores and categories
  ...
  useEffect(() => {
    const fetchStoresAndCategories = async () => {
      try {
        ...
        setStores([]); // Ensure we have an empty array on error
      } finally {
  ...
  const handleExport = async (format) => {
    try {
      ...
      if (format === 'pdf') {
        ...
        // Add title
        doc.setFontSize(18);
        doc.text('Advanced Inventory Report', 20, 20);
        ...
        // Save PDF
        doc.save(`advanced_inventory_report_${new Date().toISOString().split('T')[0]}.pdf`);
        return;
      }
      ...
      a.href = url;
      a.download = `advanced_inventory_report_${new Date().toISOString().split('T')[0]}.${format}`;
      ...
      <div className={styles.summaryGrid}>
        <div className={styles.summaryCard}>
          <div className={styles.summaryHeader}>
            ...
            <div className={styles.iconContainer} style={{ background: 'linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)' }}>
        ...
        <div className={styles.summaryCard}>
          <div className={styles.summaryHeader}>
            ...
            <div className={styles.iconContainer} style={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)' }}>
        ...
        <div className={styles.summaryCard}>
          <div className={styles.summaryHeader}>
            ...
            <div className={styles.iconContainer} style={{ background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)' }}>
        ...
        <div className={styles.summaryCard}>
          <div className={styles.summaryHeader}>
            ...
            <div className={styles.iconContainer} style={{ background: 'linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)' }}>
              <ProfitIcon sx={{ fontSize: 24, color: 'white' }} />
            </div>
          </div>
          <div className={styles.summaryCompare}>
    ...
    <div className={styles.filterCard}>
      ...
      <div className={styles.filterGrid}>
        <div className={styles.filterGroup}>
          <Autocomplete
            options={stores}
            getOptionLabel={(option) => option.store_name || option.name || option.store_no || ''}
            value={stores.find(store => String(store.store_no) === String(filters.store_no)) || null}
            onChange={(event, newValue) => {
              handleFilterChange('store_no', newValue?.store_no || '');
            }}
            isOptionEqualToValue={(option, value) => {
              // Handle both null/undefined values and actual store objects
              if (!option || !value) return option === value;
              return String(option.store_no) === String(value.store_no);
            }}
        ...
        <div className={styles.filterGroup}>
          <Autocomplete
            ...
            value={categories.find(cat => cat.name === filters.category || cat.category_name === filters.category) || null}
            onChange={(event, newValue) => {
              handleFilterChange('category', newValue?.name || newValue?.category_name || '');
            }}
            isOptionEqualToValue={(option, value) => {
              // Handle both null/undefined values and actual category objects
              if (!option || !value) return option === value;
              return (option.name === value.name) || (option.category_name === value.category_name);
            }}
        ...
        <div className={styles.chartCard}>
          ...
          <div className={styles.chartContainer}>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={reportData.groupedData}>
              ...
              {reportData.inventory
                ...
                .map((item) => (
                  <tr className={styles.tableRow} key={item.product_no}>
                    ...
                    <td className={styles.tableCell}>{formatNumber(item.quantity)}</td>
                    <td className={styles.tableCell}>
                      <Chip 
  ...
  const renderAnalyticsTab = () => (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
      <div className={styles.chartCard}>
        <div className={styles.chartHeader}>
          <LineChartIcon sx={{ marginRight: 1 }} />
    ...
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <div className={styles.inventoryReports}>
        ...
        <div className={styles.inventoryReportsHeader}>
          ...
          <h1>Advanced Inventory Reports</h1>
          <p>Enterprise-level inventory analytics and reporting with advanced insights</p>
