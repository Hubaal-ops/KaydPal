...
const Support = () => {
  ...
  // Robust user check: validate tokenUser in localStorage
  const [user, setUser] = useState(null);
  const navigate = useNavigate();
  useEffect(() => {
    function getValidUser() {
      try {
        const userStr = localStorage.getItem('tokenUser');
    ...
    setUser(validUser);
    // No redirect: allow all users to view the Support page
  }, []);
    ...
    <div className={styles.support}>
      ...
      <div className={styles.supportGrid}>
        <div className={styles.supportCard}>
          ...
          <button className={`${styles.secondaryButton} ${styles.withIcon}`} onClick={() => setShowChat(true)}>
